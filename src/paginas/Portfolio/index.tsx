...
import listaProjetosTeste from './listaProjetos.json';
...
// import imagem12 from '../../../public/projetos/12.png';
...
export default function Portfolio() {
    ...
    function passagemCarrossel(sentido: string) {
        ...
        const totalItems = listaProjetosTeste.length;
            ...
            <div className={styles.carrosselEspaco}>
                ...
                <div className={styles.carrossel}>
                    ...
                    <div className={styles.itensCarrossel}>
                        ...
                        {listaProjetosTeste.map((projeto: PropsProjetos, index: number) => {
                            return (
                                <div 
                                    key={index} 
